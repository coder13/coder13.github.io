    ...
    return {
      ...
      jobs: [{
        ...
        positions: [{
          ...
          description: 'Retail supervisor working on the frontend. Duties include assisting customers to the best of my abilities and coming up with unique solutions to fix problems.' +
          '<br/>Awarded employee of the month February 2019',
        }],
      }],
      projects: [{
        name: 'LetsCube',
