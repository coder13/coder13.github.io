    ...
    return {
      ...
      jobs: [{
        ...
        positions: [{
          ...
          description: 'Developed and maintained school\'s website written with drupal.' + '<br/>Developed reports from internal drupal data using HTML, PHP, Mysql, and javascript (Vue.js).' + '<br/>Communicated and discussed issues regarding the website and it\'s future direction.'
        }]
      }, {
        company: 'Fred Meyer',
